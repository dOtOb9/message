...
exports.initializeOIDCUser = exports.handleOIDCPostAuth = void 0;
 ...
 * ユーザープロファイルの追加情報を処理
 */
exports.handleOIDCPostAuth = (0, https_1.onCall)({
    ...
    try {
        ...
        await userDoc.set({
            ...
            providerId: ((_a = user.providerData[0]) === null || _a === void 0 ? void 0 : _a.providerId) || 'unknown',
            // OIDC固有の情報
            oidcProvider: ((_b = user.customClaims) === null || _b === void 0 ? void 0 : _b.oidc_provider) || null,
 ...
 * アプリ起動時にユーザーの認証状態を確認
 */
exports.initializeOIDCUser = (0, https_1.onCall)({
    region: "asia-northeast1",
    cors: true
}, async (request) => {
    var _a;
...
//# sourceMappingURL=firebase-oidc.js.map